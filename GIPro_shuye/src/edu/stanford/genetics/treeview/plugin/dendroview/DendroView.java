	...
	public DendroView(DataModel dataModel, ConfigNode root, ViewFrame vFrame, String name) {
		...
		if (arrayIndex != null){
			...
			setArraySelection(viewFrame.getArraySelection());
                ...
                globalXmap.setMap("Fixed");
                globalXmap.setScale(15);
                globalXmap.notifyObservers();
                globalYmap.setMap("Fixed");
                globalYmap.setScale(15);
                globalYmap.notifyObservers();
//                
//                //Select all genes
//                TreeSelectionI genSel = viewFrame.getGeneSelection();
//                genSel.selectAllIndexes();
//                setGeneSelection(genSel);
//                
//                TreeSelectionI arrSel = viewFrame.getGeneSelection();
//                arrSel.selectAllIndexes();
//                setArraySelection(arrSel);
	}
	...
	*/
	...
	// the scrollbars "scroll" by communicating with the maps.
		...
		getZoomYmap().notifyObservers();
                 ...
                 * DO FILL ON DEFAULT!!!!!!
//                 */
//                globalXmap.setMap("Fill");
//                globalXmap.notifyObservers();
//                globalYmap.setMap("Fill");
//                globalYmap.notifyObservers();
