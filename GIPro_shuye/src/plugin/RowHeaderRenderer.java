	...
	implements ChangeListener, PropertyChangeListener
{
	...
	public RowHeaderRenderer(JTable table, Vector<String> vector, Font headerFont, int width, String topLeftText)
	{
		main = table;
		...
		column.setHeaderValue("<html><font size=3><b><i>"+topLeftText+"</i></b></font></html>");
		addColumn( column );
