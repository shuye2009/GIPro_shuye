...
public class JSuggestField extends JTextField {
	 ...
	 */
	public JSuggestField(JPanel owner) {
		super();
		...
		d = new JDialog(Cytoscape.getDesktop());
	 ...
	 */
	public JSuggestField(JPanel owner, Vector<String> data) {
		this(owner);
		setSuggestData(data);
	}
	...
	/**
	 * @return The list that displays the suggestions, for adding listeners etc...
	 */
	...
	private void relocate() {
		try {
                    //For drop down below search
//			location = getLocationOnScreen();
//			location.y += getHeight();
//			d.setLocation(location);
                        
                    //For drop down above search
                        location = getLocationOnScreen();
		...
		public void run() {
			try {
				...
				while (it.hasNext()) {
					...
					// rather than using the entire list, let's remove
